...
typedef enum impFUNC_ANALYSIS_E
{
	...
	IMP_FUNC_AlarmSceneChg  = 0x00000012,	/**< 场景变换 */
...
typedef enum impTGT_EVENT_E
{
	...
	IMP_TGT_EVENT_AlarmSceneChg = 0x00000012,	/**< 场景变换 */
	...
	IMP_TGT_EVENT_OSC		    = 0x00000200,   /** <物品遗留 */
	IMP_TGT_EVENT_OSC_R		    = 0x00000400,	
}TGT_EVENT_E;
...
typedef enum impEVT_TYPE_E
{
	...
	IMP_EVT_TYPE_AlarmOsc_R		    = 0x0000010b,	
...
{
  AVD_ANALYSIS_DATA_S stAnalysisData;	/**< AVD分析数据 */
